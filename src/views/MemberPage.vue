        ...
        <v-col cols="9">
          <v-card >
            ...
            <v-card-text>
              ...
              <PaginationComponent :total-items="totalItems" :items-per-page="itemsPerPage" @page-change="handlePageChange" />
            </v-card-text>
  ...
  const searchRows = ref([
    {
      fields: [
        {
          key: "Type", label: "직원유형", type: "select", columnCount: 4,
          options: [
            {value: "전체", label: "전체"},
            {value: "정규직", label: "정규직"},
            {value: "반프리", label: "반프리"},
        ...
        {
          key: " rnak", label: "등급", type: "select", columnCount: 4,
          options: [
            {value: "전체", label: "전체"},
            {value: "초급", label: "초급"},
            {value: "중급", label: "중급"},
        ...
        {
          key: " grade", label: "직급", type: "select", columnCount: 4,
          options: [
          {value: "전체", label: "전체"},
            {value: "사장", label: "사장"},
            {value: "이사", label: "이사"},
        ...
        {
          key: "status", label: "가동현황", type: "select", columnCount: 4,
          options: [
            {value: "전체", label: "전체"},
            {value: "가동", label: "가동"},
            {value: "비가동", label: "비가동"},
    ...
    {
      fields: [
        {key: " 이름", label: "이름", type: "text", columnCount: 2}
      ]
    }
  ]);
